...
$plugin_slug = 'hide_shipping';
$get_discounts_api = WHSM_STORE_URL . 'wp-json/dots-upgrade-plugin-discounts/v2/dots-upgrade-plugin-discounts?' . wp_rand();
        ...
        <div class="pro-modal-inner">
            <div class="pro-modal-wrapper">
                <div class="pro-modal-header">
                    <img src="<?php echo esc_url( WHSM_PLUGIN_URL . 'admin/images/premium-upgrade-img/upgrade-rocket-img.png' ); ?>" alt="<?php esc_attr_e( 'Upgrade to Pro', 'woo-hide-shipping-methods' ); ?>">
                ...
                <div class="pro-modal-body">
                    ...
                    if ( ! empty( $discount_number ) ) {
                        ?>
                        <h3 class="pro-feature-title"><?php echo sprintf( esc_html__( 'Unlock Premium Features with a %s%% Discount!', 'woo-hide-shipping-methods' ), esc_html( $discount_number ) ); ?></h3>
                        <?php
                    } else {
                        ?>
                        <h3 class="pro-feature-title"><?php echo esc_html__( 'Unlock Premium Features Today!', 'woo-hide-shipping-methods' ); ?></h3>
                        <?php
                    }
                    ?>
                    <p><?php esc_html_e( 'Unlock a world of possibilities for your WooCommerce store with our Premium Hide Shipping plugin!', 'woo-hide-shipping-methods' ) ?></p>
                    <ul class="pro-feature-list">
                        <li><?php esc_html_e( 'Hide any non-compatible shipping method by shipping value.', 'woo-hide-shipping-methods' ); ?></li>
                        <li><?php esc_html_e( 'Use advanced rules to hide specific shipping methods.', 'woo-hide-shipping-methods' ); ?></li>
                        <li><?php esc_html_e( 'Hide shipping using extra advanced quantity range-based rules.', 'woo-hide-shipping-methods' ); ?></li>
                        <li><?php esc_html_e( 'Hide shipping based on specific areas, coupons, payments, etc.', 'woo-hide-shipping-methods' ); ?></li>
                    </ul>
                </div>
